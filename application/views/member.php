                        ...
                        <table id="member" class="table table-hover">
                            ...
                            if (!empty($memberRecords)) {
                                foreach ($memberRecords as $record) {
                                    ?>
                                    <tr id="<?php echo $record->id; ?>" style="cursor: pointer;" data-toggle="modal" data-target="#modal-member" data-id="<?php echo $record->id; ?>">
                                        <td data-id="full_name" data-type="in"><?php echo $record->full_name ?></td>
                                        <td data-id="address" data-type="in"><?php echo $record->address ?></td>
                                        <!-- <td data-id="dob" data-type="in"><?php echo $record->dob ?></td> -->
                                        <td data-id="contact_no" data-type="in"><?php echo $record->contact_no ?></td>
                                        <td data-id="email_id" data-type="in"><?php echo $record->email_id ?></td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control modal-input" id="full_name" placeholder="Enter name" name="full_name" value="" maxlength="128">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control modal-input" id="contact_no" placeholder="Enter number" name="contact_no" value="" maxlength="128">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="price">Email</label>
                                                <input type="text" class="form-control modal-input" id="email_id" placeholder="Enter email" name="email_id" value="" maxlength="128">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="price">Company Name</label>
                                                <select class="form-control cmbClass" id="cmb_company_name" name="cmb_company_name">
                                                    <option value="">Select Company</option>
                                                </select>
                                                <input type="hidden" class="form-control modal-input" id="company_id" placeholder="Enter company name" name="company_id" value="" maxlength="128">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="price">Occupation</label>
                                                <input type="text" class="form-control modal-input" id="occupation" placeholder="Enter occupation" name="occupation" value="" maxlength="128">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="price">Reference Source</label>
                                                <input type="text" class="form-control modal-input" id="reference_source" placeholder="Enter reference source" name="reference_source" value="" maxlength="128">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        $('.table-hover').find('tr').click(function () {
            ...
            $("#memberButtonId").show();
            $("#member-form").attr("action", "<?php echo base_url(); ?>member/editMember");
        ...
        jQuery('#memberAdd-button').click(function (e) {
            e.preventDefault();
            $('.modal-input').val('');
            $("#member-form").attr("action", "<?php echo base_url(); ?>member/addMember");
